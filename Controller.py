    ...
    def alterarCategoria(self, categoriaAlterar, categoriaAlterada):
        ...
        if len(cat) > 0:
            ...
            if len(cat1) == 0:
                ...
                # Aleterar a categoria do estoque
                estoque = DaoEstoque.ler()
...
# Alterar Categoria
a = ControllerCategoria()
a.alterarCategoria('Legumes', 'Carnes')
...
# # # Cadastrar Produtos
# # a = ControllerEstoque()
# # a.cadastrarProduto('contra file', '40', 'Carnes', 10)
